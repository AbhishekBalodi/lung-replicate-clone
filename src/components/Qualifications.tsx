    ...
    <section className="py-16 px-4 bg-gradient-to-b from-background to-lung-blue/5">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
          {/* If tenant provides qualifications text, show it as content. Otherwise fall back to static cards */}
          {typeof displayName === 'string' ? (
            <>
              { /* Use parent page to supply `doctorData` via context if needed; otherwise we try to show static content */ }
