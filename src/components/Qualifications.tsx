...
const Qualifications = () => {
  ...
  // If not Dr Mann, show a placeholder section
  if (!isDrMann) {
    return (
      <section className="py-16 px-4 bg-gradient-to-b from-background to-lung-blue/5">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex flex-col items-center justify-center py-16">
            <Building2 className="h-20 w-20 text-muted-foreground/30 mb-4" />
            <p className="text-muted-foreground text-center max-w-md">
              Qualifications and credentials will be displayed here once configured in the admin panel.
            </p>
          </div>
        </div>
      </section>
  ...
  // Dr Mann's qualifications (hardcoded for doctor_mann tenant)
  return (
    <section className="py-16 px-4 bg-gradient-to-b from-background to-lung-blue/5">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-12">
