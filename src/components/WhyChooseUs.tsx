        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          <div className="relative order-first lg:order-last">
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="bg-lung-blue/90 p-6 lg:p-8 rounded-2xl">
                <div className="w-12 h-12 lg:w-16 lg:h-16 bg-white/20 rounded-lg flex items-center justify-center transform rotate-45">
                  <div className="w-6 h-6 lg:w-8 lg:h-8 bg-white rounded transform -rotate-45"></div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 lg:gap-4 mb-6 lg:mb-8">
              {features.map((feature, index) => (
                <div key={index} className="flex items-center gap-3">
                  ...
                  <span className="text-foreground font-medium text-sm lg:text-base">{feature}</span>
                </div>
              ))}
            </div>
            ...
            <div className="space-y-3 lg:space-y-4">
              ...
              <div className="text-lung-blue">
                <p className="font-medium text-sm lg:text-base">Need an online consultation?</p>
                <Button variant="link" className="text-lung-blue p-0 h-auto font-normal underline text-sm lg:text-base">
                  Click Here →
                </Button>
              </div>
            </div>
