    ...
    <div className="min-h-screen bg-emerald-50/30">
      ...
      <div className="w-full max-w-[1600px] mx-auto px-2 sm:px-4 xl:px-6">
        <div className="grid grid-cols-1">
          ...
          {/* SIDEBAR */}
          <aside
            className={`fixed inset-y-0 left-0 z-50 w-[1000px] max-w-[90%] min-h-screen
          ...
          >
            ...
            {!activeSidebarPage && (
              <div className="flex-1 overflow-y-auto">
                ...
                {/* TODAY BOX + CONTACT (your original untouched) */}
          ...
          <div className="min-h-screen overflow-x-hidden">
            <header className="sticky top-0 z-20 bg-white/90 backdrop-blur border-b border-slate-200">
              <div className="px-3 sm:px-6 py-3 flex items-center gap-2 sm:gap-3">
                <button onClick={() => setSidebarOpen(true)} className="p-2 hover:bg-slate-100 rounded-md shrink-0">
