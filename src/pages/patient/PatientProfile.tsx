...
const PatientProfile = () => {
  ...
  const handleSave = async () => {
    try {
      setSaving(true);
      const res = await apiPut('/api/dashboard/patient/profile', {
        email: user?.email,
  ...
  const handleSaveEmergencyContact = async () => {
    try {
      setSaving(true);
      const res = await apiPut('/api/dashboard/patient/emergency-contact', {
        email: user?.email,
        ...emergencyContact,
      });
        ...
        <TabsContent value="emergency" className="mt-6">
          <Card>
            ...
            <CardContent>
              ...
              <Button className="mt-4" onClick={handleSaveEmergencyContact} disabled={saving}>
