  ...
  return (
    <ConsoleShell>
      <div className="space-y-6">
        <InstructionBanner
          title="How to Use Tasks & Notifications"
          summary="Create and manage clinical tasks, and view system notifications for your practice."
          steps={[
            { title: "Create a Task", description: "Click '+ New Task', enter the title, description, type (report, follow-up, lab, etc.), priority, and due date. Click 'Create Task'." },
            { title: "Complete Tasks", description: "Click 'Complete' on any pending task when it's done. Use the filter buttons to view Pending, Completed, or All tasks." },
            { title: "View Notifications", description: "Switch to the 'Notifications' tab to see system alerts (appointment bookings, lab results, etc.)." },
            { title: "Mark All Read", description: "Click 'Mark All Read' in the notifications tab to clear all unread notification badges." },
          ]}
          tips={[
            "High-priority tasks appear with a red indicator — address these first.",
            "Notifications are auto-generated by the system (appointments, lab results, emergency events).",
            "Use search to find tasks by title or patient name.",
          ]}
        />
